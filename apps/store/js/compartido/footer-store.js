    ...
    <footer class="bg-black text-slate-400">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div class="flex items-center justify-center gap-3 py-4 sm:py-0">
          <a href="https://www.facebook.com/outletshop.tiendavirtual/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="Facebook">
          ...
          <a href="https://www.instagram.com/OutletShop_for_my/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="Instagram">
          ...
          <a href="https://www.tiktok.com/@outletshoptienda" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="TikTok">
          ...
          <a href="https://www.threads.com/@outletshop_for_my" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="Threads">
          ...
          <a href="https://www.youtube.com/@OutletShopTiendaVirtual" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="YouTube">
          ...
          <a href="https://wa.me/573054476133" target="_blank" rel="noopener noreferrer" class="w-10 h-10 sm:w-8 sm:h-8 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all" aria-label="WhatsApp">
        ...
        <div class="hidden sm:grid sm:grid-cols-4 gap-8 mt-8">
          ...
          <div>
            ...
            <div class="flex gap-3">
              <a href="https://www.facebook.com/outletshop.tiendavirtual/" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/OutletShop_for_my/" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@outletshoptienda" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="TikTok">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.9 2.89 2.89 0 01-2.88-2.89 2.89 2.89 0 012.88-2.89c.32 0 .62.06.92.14V9.43a6.35 6.35 0 00-.92-.07A6.34 6.34 0 004.3 15.7a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.17a8.27 8.27 0 004.02 1.36v-3.4c-.27.01-.54-.02-.81-.04z"/></svg>
              </a>
              <a href="https://www.threads.com/@outletshop_for_my" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="Threads">
              ...
              <a href="https://www.youtube.com/@OutletShopTiendaVirtual" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="YouTube">
              ...
              <a href="https://wa.me/573054476133" target="_blank" rel="noopener noreferrer" class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors" aria-label="WhatsApp">
